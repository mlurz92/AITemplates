...
*   **Signature-Typografie & Kartenlayout:** Die gesamte Oberfläche setzt auf „Roboto“ (Gewichte 300–700) als konsistente Primärschrift. Adaptive Grundgrößen auf `:root` und dynamische Re-Layouts nach Font-Loads verhindern Überlagerungen, während die weich gerundeten Grotesk-Proportionen allen UI-Elementen eine ruhige, gut lesbare Anmutung verleihen.
