...
window.APP_CONFIG = Object.freeze({
    ...
    APP_VERSION: "5.1.0-radiology-final-insights",
    NA_PLACEHOLDER: '—',
    ...
    DEFAULT_SETTINGS: Object.freeze({
        ...
        INSIGHTS_TAB_DEFAULTS: Object.freeze({
            STUDY_ID: 'ESGAR_2016_Overall',
            POWER: 0.80,
            ALPHA: 0.05,
            EFFECT_SIZE_TYPE: 'observed',
            CUSTOM_EFFECT_SIZE: 0.10,
            FEATURE_IMPORTANCE_METHOD: 'univariable'
        }),
    ...
    STORAGE_KEYS: Object.freeze({
        ...
        INSIGHTS_STUDY_ID: 'avocadoSign_insightsStudyId_v5.1',
        INSIGHTS_POWER: 'avocadoSign_insightsPower_v5.1',
        INSIGHTS_ALPHA: 'avocadoSign_insightsAlpha_v5.1',
        INSIGHTS_EFFECT_SIZE_TYPE: 'avocadoSign_insightsEffectSizeType_v5.1',
        INSIGHTS_CUSTOM_EFFECT_SIZE: 'avocadoSign_insightsCustomEffectSize_v5.1',
        INSIGHTS_FEATURE_IMPORTANCE_METHOD: 'avocadoSign_insightsFeatureImportanceMethod_v5.1',
    ...
    REFERENCES_FOR_PUBLICATION: Object.freeze({
        ...
        DeLong_1988: { id: 7, text: "DeLong ER, DeLong DM, Clarke-Pearson DL. Comparing the areas under two or more correlated receiver operating characteristic curves: a nonparametric approach. Biometrics. 1988;44(3):837-845." },
    ...
    UI_TEXTS: Object.freeze({
        ...
        tooltips: Object.freeze({
            ...
            insightsTab: {
                powerAnalysis: 'Assess the statistical power of the current study or estimate the required sample size for a future study.',
                mismatchAnalysis: 'Analyze cases where the Avocado Sign and T2 criteria disagree to identify the specific diagnostic contribution of each method.',
                featureImportance: 'Evaluate which T2-weighted morphological features have the strongest association with the final nodal status.'
            },
